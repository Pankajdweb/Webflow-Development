  ...
  return (
    ...
    >
      <_Builtin.Block className={_utils.cx(_styles, "container")} tag="div">
        <_Builtin.Block
          className={_utils.cx(_styles, "footer-one-top-heading")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "footer-one-heading")}
            tag="div"
          >
            <_Builtin.Heading
              className={_utils.cx(
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "footer-one-round")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "footer-one-small-round")}
              tag="div"
            >
              <_Builtin.Image
                width="20"
                ...
                loading="lazy"
                alt="Footer Arrow"
                src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c80a_Footer%20Arow.svg"
              />
            </_Builtin.Block>
            <_Builtin.Image
              className={_utils.cx(_styles, "round-image")}
              data-w-id="cd0f26fc-c2e2-b025-1c61-ee1d76b79f7f"
              width="105"
              height="105"
              loading="lazy"
              alt="Round Text\n"
              src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c80e_Round%20Text.svg"
            />
          </_Builtin.Block>
        </_Builtin.Block>
        <_Builtin.Block
          className={_utils.cx(_styles, "footer-one-main-wrapper")}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "footer-one-logo")}
            id={_utils.cx(
              _styles,
              "w-node-cd0f26fc-c2e2-b025-1c61-ee1d76b79f81-76b79f76"
            )}
            tag="div"
          >
            <_Builtin.Link
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "footer-logo-text")}
              tag="div"
            >
              <_Builtin.Paragraph
                className={_utils.cx(_styles, "chnage-color")}
              >
                {"Communication is the anchor that keeps us together."}
              </_Builtin.Paragraph>
            </_Builtin.Block>
            <_Builtin.Block
            ...
            >
              <_Builtin.Link
                className={_utils.cx(_styles, "footer-one-social-media-icon")}
                data-w-id="cd0f26fc-c2e2-b025-1c61-ee1d76b79f88"
                button={false}
                block="inline"
                options={{
              ...
              >
                <_Builtin.Image
                  className={_utils.cx(_styles, "white-icon-social-media")}
                  width="8"
                  height="16"
                  loading="lazy"
                  alt="Facebook"
                  src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c80f_facebook.svg"
                />
              </_Builtin.Link>
              <_Builtin.Link
                className={_utils.cx(_styles, "footer-one-social-media-icon")}
                data-w-id="cd0f26fc-c2e2-b025-1c61-ee1d76b79f8a"
                button={false}
                block="inline"
                options={{
              ...
              >
                <_Builtin.Image
                  ...
                  loading="lazy"
                  alt="Linkedin"
                  src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c810_Linkedin.svg"
                />
              </_Builtin.Link>
              <_Builtin.Link
                className={_utils.cx(_styles, "footer-one-social-media-icon")}
                data-w-id="cd0f26fc-c2e2-b025-1c61-ee1d76b79f8c"
                button={false}
                block="inline"
                options={{
              ...
              >
                <_Builtin.Image
                  ...
                  loading="lazy"
                  alt="Twitter"
                  src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c811_twitter-_5_%202.svg"
                />
              </_Builtin.Link>
              <_Builtin.Link
                className={_utils.cx(_styles, "footer-one-social-media-icon")}
                data-w-id="cd0f26fc-c2e2-b025-1c61-ee1d76b79f8e"
                button={false}
                block="inline"
                options={{
              ...
              >
                <_Builtin.Image
                  ...
                  loading="lazy"
                  alt="Instagram"
                  src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c812_Instagram.svg"
                />
              </_Builtin.Link>
            </_Builtin.Block>
          </_Builtin.Block>
          <_Builtin.Block
            className={_utils.cx(_styles, "footer-one-item")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "footer-one-item-heading")}
              tag="div"
            >
              <_Builtin.Block
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "footer-one-item-details")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "chnage-color")}
            ...
            <_Builtin.Link
              className={_utils.cx(_styles, "footer-item-link")}
              button={false}
              block="inline"
              options={{
                href: "#",
            ...
            >
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "display-off")}
                tag="div"
              >
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "footer-item-call")}
              tag="div"
            >
              <_Builtin.Image
                width="33"
                ...
                loading="lazy"
                alt="Call"
                src="https://cdn.prod.website-files.com/6835ac0e320162939cd9c7ad/6835ac0e320162939cd9c832_About%20us.svg"
              />
              <_Builtin.Block
                className={_utils.cx(_styles, "footer-call-item-main")}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "chnage-color")}
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-cd0f26fc-c2e2-b025-1c61-ee1d76b79fa5-76b79f76"
            )}
            tag="div"
          >
            <_Builtin.Block
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "footer-item-locatiion")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "chnage-color-white")}
                tag="div"
              >
                {"Location"}
              </_Builtin.Block>
            ...
            >
              ...
              <_Builtin.Link
                className={_utils.cx(_styles, "chnage-color", "hover-text")}
                button={false}
                block=""
                options={{
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-cd0f26fc-c2e2-b025-1c61-ee1d76b79fb5-76b79f76"
            )}
            tag="div"
          >
            <_Builtin.Block
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "footer-one-bottom-link")}
          tag="div"
        >
          <_Builtin.Block
