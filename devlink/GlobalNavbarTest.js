...
import _styles from "./GlobalNavbarTest.module.css";
...
export function GlobalNavbarTest({ as: _Component = _Builtin.Section }) {
    ...
    >
      <_Builtin.Block tag="div">
        <_Builtin.NavbarWrapper
          className={_utils.cx(_styles, "global_navbar")}
          tag="div"
          config={{
            easing: "ease",
            easing2: "ease",
        ...
        >
          <_Builtin.Block className={_utils.cx(_styles, "nav-grid")} tag="div">
            <_Builtin.Block
              className={_utils.cx(
                _styles,
              ...
              id={_utils.cx(
                _styles,
                "w-node-_13801f0c-938a-8482-7556-8e28f6ea9c4b-f6ea9c47"
              )}
              tag="div"
            >
              <_Builtin.NavbarBrand
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_13801f0c-938a-8482-7556-8e28f6ea9c4c-f6ea9c47"
                )}
                options={{
                  href: "#",
                }}
            ...
            <_Builtin.NavbarMenu
              ...
              id={_utils.cx(
                _styles,
                "w-node-_13801f0c-938a-8482-7556-8e28f6ea9c4f-f6ea9c47"
              )}
              tag="nav"
              role="navigation"
            >
              <_Builtin.DropdownWrapper
                className={_utils.cx(_styles, "navbar_dropdown")}
                tag="div"
                delay={0}
                hover={true}
              >
                ...
                >
                  <_Builtin.Block
                    className={_utils.cx(_styles, "menu-font", "is-test")}
                    tag="div"
                  >
                    {"R&Dservices"}
                  </_Builtin.Block>
                ...
                <_Builtin.DropdownList
                  className={_utils.cx(_styles, "dropdown_menu-list")}
                  tag="nav"
                >
                  <_Builtin.DropdownLink
                    className={_utils.cx(_styles, "dropdown_menu-link")}
                    options={{
                      href: "#",
                    }}
                  >
            ...
            <_Builtin.NavbarButton
              ...
              id={_utils.cx(
                _styles,
                "w-node-_13801f0c-938a-8482-7556-8e28f6ea9c93-f6ea9c47"
              )}
              tag="div"
            >
              <_Builtin.Block tag="div">
                <_Builtin.NavbarButton
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-_13801f0c-938a-8482-7556-8e28f6ea9c95-f6ea9c47"
                  )}
                  tag="div"
                >
                  <_Builtin.Block
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "nav_button-wrap")}
              id={_utils.cx(
                _styles,
                "w-node-_13801f0c-938a-8482-7556-8e28f6ea9c99-f6ea9c47"
              )}
              tag="div"
            >
              <GlobalButton
